...
class Obat extends ResourceController {
    ...
    public function show($id = null) //menampilkan data obat berdasarkan id
    {
        $data = $this->model->find($id);

        if (!$data) {
            return $this->failNotFound("Data obat ID $id tidak ditemukan.");
        }
    ...
    {
        // mengambil data JSON dalam bentuk array
    ...
    {
        // Mwngecek apakah data dengan ID ini ada
